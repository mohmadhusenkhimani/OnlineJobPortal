           ...
           <%-- <div>
            ...
            <div class="btn-toolbar justify-content-between mb-3">
                ...
                <div class="input-group h-25">
                    <asp:HyperLink ID="linkBack" runat="server" NavigateUrl="~/Admin/JobList.aspx" CssClass="btn btn-secondary" Visible="false">< Bcak</asp:HyperLink>
                </div>
            </div>
              <h3 class="text-center"><% if (Session["title"] != null) { Response.Write(Session["title"]); } else { Response.Write("New Job"); } %></h3>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                ...
                <div class="col-md-6 pt-3">
                    ...
                    <asp:DropDownList ID="ddlJobType" runat="server" CssClass="form-control">
                        <asp:ListItem Value="0">Selected Job Type</asp:ListItem>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtWebsite" runat="server" CssClass="form-control" placeholder="Enter Specialization" TextMode="Url"></asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
