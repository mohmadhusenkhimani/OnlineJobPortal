                        ...
                        <div class="job-category-listing mb-50">
                            ...
                            <div class="single-listing">
                               <div class="small-section-tittle2">
                                ...
                                <!-- select-Job title start -->
                                <div class="select-Categories pt-80 pb-50">
                                    <div class="small-section-tittle2">
                                        <h4>Job Title</h4>
                                    </div>
                                    <div class="checkbox checkbox-primary">
                                    <asp:CheckBoxList ID="CheckBoxList2" runat="server" AutoPostBack="True" CssClass="styled" OnSelectedIndexChanged="CheckBoxList2_SelectedIndexChanged" RepeatLayout="Flow">
                                        <asp:ListItem>Web Developer</asp:ListItem>
                                        <asp:ListItem>Frontend  Developer</asp:ListItem>
                                        <asp:ListItem>AI/MLDeveloper</asp:ListItem>
                                        <asp:ListItem>Backend</asp:ListItem>
                                    </asp:CheckBoxList>
                                    </div>
                                </div>
                                <!-- select-Job Title End -->
                                ...
                                <div class="select-Categories pt-80 pb-50">
                                    ...
                                    <div class="checkbox checkbox-primary">
                                    <asp:CheckBoxList ID="CheckBoxList3" runat="server" AutoPostBack="True" CssClass="styled" OnSelectedIndexChanged="CheckBoxList3_SelectedIndexChanged" RepeatLayout="Flow">
                                        <asp:ListItem>Microsoft</asp:ListItem>
                                        <asp:ListItem>abc</asp:ListItem>
                                        <asp:ListItem>Infotech</asp:ListItem>
